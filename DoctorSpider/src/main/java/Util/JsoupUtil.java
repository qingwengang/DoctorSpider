...
public class JsoupUtil {
	...
	public static Document GetDocument(String url,String proxyIP,int proxyPort) {
		...
		while (flag) {
			try {
				doc=Jsoup.connect(url).userAgent("Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.31 (KHTML, like Gecko) Chrome/26.0.1410.64 Safari/537.31").timeout(600000).get();
